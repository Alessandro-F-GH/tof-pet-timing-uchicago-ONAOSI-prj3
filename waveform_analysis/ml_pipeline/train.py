...
def search_model(spec,model_config,config,dataset,mode:str,*,seed:int,logger=None)->SearchResult:
    ...
    def fit_candidate(parameters,candidate_seed): return _fit_once(spec,model_config,parameters,train_x,train_target,seed=candidate_seed,validation_x=validation_x,validation_target=validation_target)
