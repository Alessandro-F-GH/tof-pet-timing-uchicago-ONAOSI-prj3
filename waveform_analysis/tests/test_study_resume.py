...
class ExperimentResumeTests(unittest.TestCase):
    ...
    def test_model_study_requests_stale_prepared_cache_refresh(self):
        config = {
            "experiment": {
                "type": "model_study",
                "output_dir": "unused",
        ...
        self.assertEqual(len(calls), 2)
        self.assertTrue(calls[0]["rebuild_stale_prepared"])
        self.assertTrue(calls[1]["rebuild_stale_prepared"])
