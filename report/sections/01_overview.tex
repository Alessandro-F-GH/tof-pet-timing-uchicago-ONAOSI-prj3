...
The comparison is repeated for two fixed waveform regions defined in the shared analysis profile. The \textbf{Onishi window} extends from \SI{-1.5}{ns} to \SI{2.0}{ns}, while the \textbf{wide window} extends from \SI{-2.0}{ns} to \SI{30.0}{ns}. This separates the model-architecture question from the amount of temporal context provided to the model.
