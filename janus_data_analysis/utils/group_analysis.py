...
def _build_summary_row(
    ...
    return {
        ...
        "ctr_coverage_fraction": _finite_number(fit.coverage_fraction),
        "ctr_interval_center_ps": _finite_number(fit.center_ps),
        "ctr_interval_low_ps": _finite_number(fit.interval_low_ps),
        "ctr_interval_high_ps": _finite_number(fit.interval_high_ps),
